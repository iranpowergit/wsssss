--Begin Report.lua By @GODILOVEYOUME2
local function run(msg, matches)
 local ldata = load_data(_config.moderation.data)
 if matches[1]:lower() == 'setmaster' and is_admin(msg) or matches[1] == 'ست مستر' and is_admin(msg) then
  ...
  if chk then
   ...
   return '_ایدی مستر ذخیره شد_'
    ...
    if matches[1]:lower() == 'report' and msg.reply_to_message_id_ or matches[1] == 'ریپورت' and msg.reply_to_message_id_ then
  local user_name = ''
